        ...
        children: [
          ...
          Padding(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'Copie uma Imagem aqui(Opcional)',
          ...
          Padding(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                labelText: 'Seu Nome',
                labelStyle: FlutterFlowTheme.of(context).bodyMedium,
                hintText: 'Por qual nome você atende?',
                hintStyle: FlutterFlowTheme.of(context).bodyMedium,
                enabledBorder: OutlineInputBorder(
                  borderSide: BorderSide(
                    color: Color(0x00000000),
          ...
          Padding(
            ...
            child: TextFormField(
              ...
              validator: _model.tituloControllerValidator.asValidator(context),
            ),
          ),
          Padding(
            padding: EdgeInsetsDirectional.fromSTEB(20.0, 20.0, 20.0, 0.0),
            ...
            child: FFButtonWidget(
              onPressed: () async {
                await currentUserReference!.update(createUsersRecordData(
                  ...
                  userRole: _model.tituloController.text,
                  createdTime: getCurrentTimestamp,
                  email: '',
                  phoneNumber: currentPhoneNumber,
                  password: '',
                  idade: valueOrDefault(currentUserDocument?.idade, 0),
                ));
